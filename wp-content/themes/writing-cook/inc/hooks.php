...
function load_recipes_by_category() {
  ...
  $args = array(
      ...
      'posts_per_page' => 4, // Количество рецептов на странице
      'paged' => $paged,
  );
  ...
  if ($query->have_posts()) {?> 
    ...
    $pagination = paginate_links(array(
      ...
      'current' => $paged,
      'format' => '?paged=%#%',
      'show_all' => false, // Отображение только активных страниц
      'prev_text' => '&laquo;', // Текст для кнопки "Предыдущая страница"
      'next_text' => '&raquo;', // Текст для кнопки "Следующая страница"
  ));
